...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        try {
            ...
            // Silently fail if database is not available yet (e.g., during installation or testing)
            // This prevents errors during composer install or when database doesn't exist
        }
    }
}
